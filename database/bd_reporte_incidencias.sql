...
INSERT INTO `estudiante` VALUES (1,'Pedro Giovanni','Ricra','Figueroa','pedro.ricra@gmail.com','922149396','Ingeniería de Sistemas','Facultad de Ingeniería de Sistemas y Civil','0002221081','$2b$10$UtxUX3KOUT5lSBwQNYwrI.te8IrqJi2OQip9FxntNoqpVoGMmKfKq'),(2,'Leonardo Franco','Campos','Inuma','leonardo.campos@gmail.com','912345678','Ingeniería de Sistemas','Facultad de Ingeniería de Sistemas y Civil','0002221057','$2b$10$T04eZVMm/SWO43uVuzz24uT7Ep4uKyXXDugZKoei87RTuhnGqlNIq'),(3,'Lenin Oseas','Aponte','Abisrror','Yukijira2004@gmail.com','995318921','Derecho','Facultad de derecho y ciencias políticas','0002210376','$2b$10$pRqyZmb9wLuLLlylUsN3gODNARHMDFi1KD4.2SjPucYp1/Spyn95e');
...
INSERT INTO `reaccion` VALUES (1,1,2,1),(2,2,3,0),(3,3,3,1),(4,1,4,0),(5,2,4,1),(6,3,4,0),(7,1,5,1),(8,2,5,0),(9,3,6,1),(10,1,8,0),(11,2,9,1),(12,3,9,0),(13,1,10,1),(14,2,10,0),(15,3,10,1);
...
INSERT INTO `reporte` VALUES (1,'Grieta en pared del aula','Se observó una grieta en la pared del aula, cerca de la puerta. La fisura es visible y parece haberse extendido con el tiempo. Se solicita inspección técnica para identificar la causa (humedad o asentamiento), aplicar resane/refuerzo y prevenir desprendimientos o filtraciones que afecten la seguridad del ambiente.','/uploads/reportes/HuH-Oc2Jx5BWnG__.jpg','2025-12-01 01:10:38','2025-12-19 01:10:38',0,1,2,1,1,1),(2,'Sillas dañadas en salón','Varias sillas del salón tienen patas sueltas y estructura inestable; al sentarse se mueven o se ladean. Esto incrementa el riesgo de caídas y lesiones durante clases. Se recomienda retirar las unidades dañadas, ajustar tornillos y uniones, reforzar o reemplazar las que presenten piezas quebradas.','/uploads/reportes/ArvQF4yVHRl3FrLW.jpg','2025-12-01 01:10:38','2025-12-28 08:10:38',1,2,2,2,4,2),(3,'Proyector no enciende','El proyector no enciende al conectarlo y no muestra señal, impidiendo presentaciones. Se requiere revisar cable de poder, adaptador, toma eléctrica y estado del botón/indicadores. Solicitar mantenimiento para diagnóstico (fuente, fusible o falla interna) y reparación o sustitución para restablecer el servicio.','/uploads/reportes/osJVkfbBb0nUrbjw.jpg','2025-12-01 01:10:38','2025-12-15 01:10:38',2,3,2,3,7,1),(4,'Tomacorriente chispea','Al usar el tomacorriente, se producen chispas al conectar un cargador, indicando posible falso contacto o deterioro interno. Es un riesgo eléctrico y puede dañar equipos o causar cortocuitos. Se pide deshabilitarlo y señalizarlo de inmediato, reemplazar el punto y realizar pruebas de seguridad antes de habilitarlo.','/uploads/reportes/5sZrpCBrPhsdzT2q.jpg','2025-12-01 01:10:38','2025-12-09 01:10:38',3,1,2,4,10,2),(5,'Falta limpieza en pasillo','En el pasillo hay basura acumulada y mal olor persistente, afectando la higiene y el tránsito. Se solicita limpieza inmediata, retiro de residuos y desinfección si corresponde. Además, reforzar la frecuencia de mantenimiento y verificar la colocación de tachos para evitar que el problema se repita.','/uploads/reportes/2aAt8k4LXA5FjuT.jpg','2025-12-01 01:10:38','2025-12-02 01:10:38',2,2,2,8,13,1),(6,'Puerta del aula desajustada','La puerta del aula no cierra correctamente y presenta dificultad al abrir y cerrar, generando ruidos y riesgo de golpes en los usuarios. El problema podría deberse a desgaste de bisagras o desalineación del marco. Se solicita revisión técnica, ajuste o reemplazo de herrajes para garantizar un uso seguro.','/uploads/reportes/haGhQj8IhCh1xvCd.jpg','2025-12-01 01:10:38','2025-12-04 10:05:11',1,3,2,1,16,2),(7,'Ventilador con ruido excesivo','El ventilador del aula emite ruidos anormales durante su funcionamiento, lo que distrae a los estudiantes y podría indicar desgaste del motor o aspas desbalanceadas. Se recomienda inspección técnica, mantenimiento correctivo o reemplazo del equipo si corresponde.','/uploads/reportes/mQt0n6-5GCdE8DQI.jpg','2025-12-01 01:10:38','2025-12-08 08:21:55',0,1,2,3,19,1),(8,'Luminaria parpadeante','Una de las luminarias del aula presenta parpadeo constante, afectando la visibilidad y provocando incomodidad visual. El problema podría estar relacionado con el balasto, cableado o el foco. Se solicita revisión eléctrica y reemplazo de componentes defectuosos.','/uploads/reportes/VKbnxT5H6oqN-CSH.jpg','2025-12-01 01:10:38','2025-12-12 11:03:09',1,2,2,4,22,2),(9,'Pizarra deteriorada','La pizarra del aula se encuentra rayada y con la superficie desgastada, dificultando la correcta escritura y lectura del contenido. Se recomienda evaluar su restauración o reemplazo por una nueva para garantizar condiciones adecuadas de enseñanza.','/uploads/reportes/O8YqU3jCeSmT7Uxa.jpg','2025-12-01 01:10:38','2025-12-16 09:41:20',2,3,2,2,25,1),(10,'Enchufe flojo en pared','Se detectó un enchufe flojo en la pared del aula, el cual presenta movimiento al conectar dispositivos. Esto representa un riesgo eléctrico y posible daño a los equipos. Se solicita reparación inmediata, asegurando la correcta fijación y funcionamiento del tomacorriente.','/uploads/reportes/p0n837P9gGu4pi0T.jpg','2025-12-01 01:10:38','2025-12-20 15:27:48',3,1,2,4,27,2);
...
INSERT INTO `usuario` VALUES (1,'0001111000','$2b$10$EQvpjLaRJur.SuNLXMgSdO1NYebJ8gMdbdQxjsr56qwDq4rwGyn1y',1,NULL,1),(2,'0002222000','$2b$10$dXZ0HiOtjltUHwfnKSeNkeNkif/IzfgjdciAgocOe5T/24HvpsF9y',2,NULL,2),(3,'0002221081','$2b$10$UtxUX3KOUT5lSBwQNYwrI.te8IrqJi2OQip9FxntNoqpVoGMmKfKq',3,1,NULL),(4,'0002221057','$2b$10$T04eZVMm/SWO43uVuzz24uT7Ep4uKyXXDugZKoei87RTuhnGqlNIq',3,2,NULL),(5,'0002210376','$2b$10$pRqyZmb9wLuLLlylUsN3gODNARHMDFi1KD4.2SjPucYp1/Spyn95e',3,3,NULL);
...
-- Dump completed on 2025-12-28 21:15:35
